  ...
  const ctaCard = (
    <>
      <div className="flex h-full flex-col items-start justify-center gap-4">
        <h1 className="text-5xl font-light">Provide collateral to borrow any asset</h1>
      ...
      <div className="hidden items-center justify-end md:flex md:max-h-72">
        <video loop={true} autoPlay={true} preload="metadata" playsInline={true} className="aspect-square h-full">
          <source src="https://cdn.morpho.org/v2/assets/videos/borrow-animation.mov" type="video/mp4; codecs='hvc1'" />
          <source
            src="https://cdn.morpho.org/v2/assets/videos/borrow-animation.webm"
